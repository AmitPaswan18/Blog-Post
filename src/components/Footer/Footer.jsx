...
function Footer() {
  return (
    <section className="relative overflow-hidden py-10 border-t-2 border-white  bg-gradient-to-r from-slate-900 via-gray-900 to-black text-white border-t-black">
